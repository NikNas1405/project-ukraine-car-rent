import{s as x,g as M,b as Xe,d as ge,r as K,j as l,e as Ze,h as Ge,i as et,a as tt,k as nt,N as ot}from"./index-1ee90065.js";let rt=(t=21)=>crypto.getRandomValues(new Uint8Array(t)).reduce((e,n)=>(n&=63,n<36?e+=n.toString(36):n<62?e+=(n-26).toString(36).toUpperCase():n>62?e+="-":e+="_",e),"");const zn=t=>t.adverts,Kn=t=>t.filtersAdverts,at=t=>t.isLoading,it=t=>t.error,lt=t=>t.favorites,Vn=t=>t.formData,Yn=t=>t.isFilter,st=x.li`
...
`),J=U[0].split(":"),pe=J[0].trim(),he=parseInt(J[1].trim(),10),ee=Dn(g);K.useEffect(()=>{const P=document.body;return e?P.style.overflow="hidden":P.style.overflow="visible",()=>{P.style.overflow="visible"}},[e]);const me={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",display:"flex",justifyContent:"center",alignItems:"center",backgroundColor:"rgba(18, 20, 23, 0.50)",zIndex:1e3,overflow:"auto"},content:{maxWidth:"fit-content",maxHeight:"fit-content",margin:"auto",overflow:"auto",inset:0,border:"none",background:"none",padding:0}};return l.jsx(Ve,{isOpen:e,onRequestClose:n,onClick:n,style:me,children:l.jsxs(Pn,{children:[l.jsx(Nn,{onClick:n,children:l.jsx("svg",{children:l.jsx("use",{href:je+"#icon-close"})})}),l.jsx(An,{children:l.jsx("img",{src:b,alt:"car",loading:"lazy",onError:r})}),l.jsxs(jn,{children:[l.jsxs("span",{children:[i," "]}),l.jsxs("span",{children:[y,", "]}),l.jsx("span",{children:p})]}),l.jsxs(Fn,{children:[l.jsx("li",{children:W[1]}),l.jsx("li",{children:W[2]}),l.jsxs("li",{children:["Id: ",u]}),l.jsxs("li",{children:["Year: ",p]}),l.jsxs("li",{children:["Type: ",a]}),l.jsxs("li",{children:["Fuel Consumption: ",O]}),l.jsxs("li",{children:["Engine Size",T]})]}),l.jsx(Ln,{children:v}),l.jsx(Ae,{children:"Accessories and functionalities: "}),l.jsxs(kn,{children:[D.map((P,N)=>l.jsx("li",{children:P},N)),Y.map((P,N)=>l.jsx("li",{children:P},N))]}),l.jsx(Ae,{children:"Rental Conditions: "}),l.jsxs(Un,{children:[U.map((P,N)=>l.jsx("li",{children:N===0?l.jsxs(l.Fragment,{children:[pe,": ",l.jsx("span",{children:he})]}):P},N)),l.jsxs("li",{children:["Mileage: ",l.jsx("span",{children:B})]}),l.jsxs("li",{children:["Price: ",l.jsxs("span",{children:[ee,"$"]})]})]}),l.jsx("div",{children:l.jsx(In,{href:"tel:+380730000000",type:"button",children:"Rental car"})})]})})},Bn=x.div`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;export{Gn as B,Xn as C,Zn as N,zn as a,Kn as b,Yn as c,Vn as d,lt as e,Jn as f,rt as n,Qn as p,at as s};
