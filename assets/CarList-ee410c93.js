import{s as x,g as k,b as Xe,d as ye,r as K,j as s,e as Ze,h as Ge,i as et,a as tt,k as nt}from"./index-e7de7906.js";const qn=t=>t.adverts,zn=t=>t.filtersAdverts,ot=t=>t.isLoading,rt=t=>t.error,at=t=>t.favorites,Kn=t=>t.formData,Vn=t=>t.isFilter;let lt=(t=21)=>crypto.getRandomValues(new Uint8Array(t)).reduce((e,n)=>(n&=63,n<36?e+=n.toString(36):n<62?e+=(n-26).toString(36).toUpperCase():n>62?e+="-":e+="_",e),"");const st=x.li`
...
`,Qn=({adverts:t,showLoadMoreButton:e,handleLoadMore:n})=>{const r=ye(rt),l=ye(ot),[p,g]=K.useState(null),[a,b]=K.useState(!1);function m(u){b(!0),g(u)}const y=()=>{a&&b(!1),g(null)},d=u=>{u.target.src="https://media.istockphoto.com/id/1406492902/uk/%D1%84%D0%BE%D1%82%D0%BE/%D0%B0%D0%B2%D1%82%D0%BE%D0%BC%D0%BE%D0%B1%D1%96%D0%BB%D1%8C%D0%BD%D0%B8%D0%B9-%D0%B2%D0%BE%D1%81%D0%BA%D0%BE%D0%BC.jpg?s=2048x2048&w=is&k=20&c=Q8L6dzJULqqLgBE270N2mRZAE3glTUbLuV7wS1X02Kw="};return s.jsxs(s.Fragment,{children:[s.jsxs(Wn,{children:[s.jsx(Bn,{children:t.map(u=>s.jsx(vt,{car:u,handleOpenModal:m,handleImageError:d},u.id?u.id:lt()))}),!r&&e&&!l&&s.jsx(Hn,{onClick:n,children:"Load more"})]}),p&&s.jsx(In,{car:p,isOpen:a,closeModal:y,handleImageError:d})]})};export{Qn as C,qn as a,zn as b,Vn as c,Kn as d,at as e,Yn as f,lt as n,Jn as p,ot as s};
